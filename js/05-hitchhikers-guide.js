document.write('<h3>Hitchhiker’s Guide to the Galaxy</h3>')

let answer = prompt('Are you ready to play? (Yes or No)')
    if (answer == "Yes") {
        ...
        alert('Come play again sometime!')
    }

let rating = parseInt(prompt('Rate the game between 1 and 10'))
    if (rating >= 6 && rating <= 10) {
        alert('Thanks for playing! You should play again!')
    } else if (rating >= 1 && rating <= 5) {
        alert('Thanks for playing! We are working hard to improve the game!')
    } else (rating < 1 && rating > 10) 
